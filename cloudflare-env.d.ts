/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 9d3231633a92f9f3285d64cd2d9a394f)
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      Cloudflare.Env,
      'GITHUB_PAT' | 'FORM_ENDPOINT' | 'FORMSPREE_FORM_ID' | 'GOOGLE_GENERATIVE_AI_API_KEY'
    >
  > {}
}
