...
declare namespace Cloudflare {
	...
	interface Env {
		...
		Chat: DurableObjectNamespace<import("./worker/entry").Chat>;
		RateLimiter: DurableObjectNamespace<import("./worker/entry").RateLimiter>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_PAT" | "FORM_ENDPOINT" | "FORMSPREE_FORM_ID">> {}
}
